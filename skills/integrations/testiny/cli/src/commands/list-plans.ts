...
import type { TestinyTestPlan, TestinyFindResponse } from '../types';
...
export async function listPlans(args: ListPlansArgs): Promise<void> {
  ...
  const result = await request<TestinyFindResponse<TestinyTestPlan>>(
    'POST',
    '/testplan/find',
